      ...
      <div className="w-full">
        <div className=" mx-auto p-0" width={80}>
          <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
            <div>
                <img src="https://istad.co/resources/img/CSTAD_120.png" alt="logo_istad" />
                ...
                <Footer.LinkGroup col className="text-gray-100">
                  ...
                  <Footer.LinkGroup className="flex text-gray-100 items-center">
                    <Footer.Link className="flex items-center">
                      <FaTelegram className="float-left text-2xl" />&nbsp; Telegram
                    </Footer.Link>
                    <Footer.Link className="flex items-center ml-4">
                      <FaYoutube className="float-left text-2xl" />&nbsp; Youtube
                    </Footer.Link>
                  </Footer.LinkGroup>
                </Footer.LinkGroup>
              </div>
